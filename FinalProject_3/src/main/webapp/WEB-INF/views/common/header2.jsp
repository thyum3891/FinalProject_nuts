            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ml-5" id="navbar_global">
                    <ul class="navbar-nav navbar-nav-hover justify-content-center">
                        <li class="nav-item dropdown">
                            <a href="${path}/walking/view" id="mainPagesDropdown" class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown">
                                <span class="nav-link-inner-text mr-1 font-medium" style="color: #5E4D44;">산책하기</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown ml-5">
                            <a href="${path}/park/list" id="dashboardPagesDropdown" class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown">
                                <span class="nav-link-inner-text mr-1 font-medium" style="color: #5E4D44;">공원조회</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown ml-5">
                            <a href="${path}/hospital/view" id="dashboardPagesDropdown" class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown">
                                <span class="nav-link-inner-text mr-1 font-medium" style="color: #5E4D44;">동물병원</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown ml-5">
                            <a href="${path}/shop/search" id="dashboardPagesDropdown" class="nav-link dropdown-toggle" aria-expanded="false" data-toggle="dropdown">
                ...
                <c:if test="${loginMember != null }">
	                <div class="d-none d-lg-block mr-3">
	                    <div style="border-radius: 50%; background: #BA9F81; width: 70px; height: 70px;">
	                        <img src="${path }/resources/upload/member/${loginMember.profile_re_name}" style="margin: 7.5%; width: 60px; height: 60px; border-radius: 50%;">
	                    </div>
	                </div>
                </c:if>
                <c:if test="${loginMember == null }">
